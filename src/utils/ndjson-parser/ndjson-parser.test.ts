...
describe('NDJSONStreamParser', () => {
	...
	describe('processChunk', () => {
		...
		it('should handle nested objects', () => {
			const chunk =
				'{"user":{"id":1,"name":"John","address":{"city":"NYC","zip":"10001"}},"active":true}\n';
		...
		it('should handle arrays in JSON', () => {
			const chunk =
				'{"items":[1,2,3],"tags":["a","b","c"],"matrix":[[1,2],[3,4]]}\n';
		...
		it('should handle numeric values correctly', () => {
			const chunk =
				'{"int":42,"float":3.14,"negative":-100,"scientific":1.23e-4,"zero":0}\n';
