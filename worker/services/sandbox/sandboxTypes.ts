...
export type CommandExecutionResult = z.infer<
...
export type TemplateDetailsResponse = z.infer<
	typeof TemplateDetailsResponseSchema
>;
...
export type GetTemplateFilesRequest = z.infer<
	typeof GetTemplateFilesRequestSchema
>;
...
export type GetTemplateFilesResponse = z.infer<
	typeof GetTemplateFilesResponseSchema
>;
...
export type ExecuteCommandsRequest = z.infer<
	typeof ExecuteCommandsRequestSchema
>;
...
export type ExecuteCommandsResponse = z.infer<
	typeof ExecuteCommandsResponseSchema
>;
...
export type PromoteToTemplateRequest = z.infer<
	typeof PromoteToTemplateRequestSchema
>;
...
export type PromoteToTemplateResponse = z.infer<
	typeof PromoteToTemplateResponseSchema
>;
...
export type StaticAnalysisResponse = z.infer<
	typeof StaticAnalysisResponseSchema
>;
...
export type WebhookRuntimeErrorEvent = z.infer<
	typeof WebhookRuntimeErrorEventSchema
>;
...
export type WebhookBuildStatusEvent = z.infer<
	typeof WebhookBuildStatusEventSchema
>;
...
export const WebhookDeploymentStatusEventSchema = WebhookEventBaseSchema.extend(
	{
		...
		payload: z.object({
			status: z.enum(['started', 'completed', 'failed']),
			deploymentType: z
				.enum(['preview', 'cloudflare_workers'])
				.optional(),
			deployedUrl: z.string().optional(),
			deploymentId: z.string().optional(),
			error: z.string().optional(),
...
export type WebhookDeploymentStatusEvent = z.infer<
	typeof WebhookDeploymentStatusEventSchema
>;
...
export type WebhookInstanceHealthEvent = z.infer<
	typeof WebhookInstanceHealthEventSchema
>;
...
export type WebhookCommandExecutionEvent = z.infer<
	typeof WebhookCommandExecutionEventSchema
>;
...
export type RunnerServiceWebhookPayload = z.infer<
	typeof RunnerServiceWebhookPayloadSchema
>;
